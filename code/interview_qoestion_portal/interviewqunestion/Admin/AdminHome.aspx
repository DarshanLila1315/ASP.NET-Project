<%@ Page Title="Admin Home" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="AdminHome.aspx.cs" Inherits="interview_questions.Admin.AdminHome" %>
            ...
            <div class="actions-grid">
                <asp:HyperLink runat="server" NavigateUrl="~/Admin/ManageCategories.aspx" CssClass="action-card">
                    ...
                    <div class="action-content">
                        ...
                        <div class="action-desc">Create new question categories</div>
                    </div>
                </asp:HyperLink>
                ...
                <asp:HyperLink runat="server" NavigateUrl="~/Admin/ManageCompanies.aspx" CssClass="action-card">
                    ...
                    <div class="action-content">
                        ...
                        <div class="action-desc">Register new partner company</div>
                    </div>
                </asp:HyperLink>
                ...
                <asp:HyperLink runat="server" NavigateUrl="~/Admin/ManageQuestions.aspx" CssClass="action-card">
                    ...
                    <div class="action-content">
                        ...
                        <div class="action-desc">Add new question to bank</div>
                    </div>
                </asp:HyperLink>
                ...
                <asp:HyperLink runat="server" NavigateUrl="~/Admin/ManageTests.aspx" CssClass="action-card">
                    ...
                    <div class="action-content">
                        ...
                        <div class="action-desc">Setup new assessment test</div>
                    </div>
                </asp:HyperLink>
                ...
                <asp:HyperLink runat="server" NavigateUrl="~/Admin/AssignQuestions.aspx" CssClass="action-card">
                    ...
                    <div class="action-content">
                        ...
                        <div class="action-desc">Link questions to tests</div>
                    </div>
                </asp:HyperLink>
