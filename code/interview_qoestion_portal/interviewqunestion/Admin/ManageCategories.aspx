<%@ Page Title="Manage Categories" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="ManageCategories.aspx.cs" Inherits="interview_questions.Admin.ManageCategories" %>
        ...
        <style>
            ...
            * {
            ...
            @media (max-width: 768px) {
                ...
                .table-mobile-cards>tbody>tr.data-row>td:first-child::before {
                ...
                /* Pagination Row Override - Force Horizontal */
            ...
            /* Pagination Styling - Modern Design (Matching Questions.aspx) */
            .pagination-container {
                padding: 1.5rem;
                display: flex;
            ...
            /* Force table to be flex container */
        ...
        <div class="table-card">
            ...
            <div class="table-wrapper">
                <asp:GridView ID="gvCategories" runat="server" AutoGenerateColumns="False"
                    CssClass="table table-mobile-cards" DataKeyNames="Category_ID"
                    OnRowCommand="gvCategories_RowCommand" GridLines="None" ShowHeaderWhenEmpty="True"
                            ...
                            <ItemTemplate>
                                <div class="action-buttons">
                                    <asp:LinkButton ID="btnEdit" runat="server" CommandName="EditRow"
                                        CommandArgument='<%# Eval("Category_ID") %>' CssClass="btn btn-sm btn-warning">
                                        <i class="fas fa-edit"></i> <span class="btn-text">Edit</span>
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="btnDelete" runat="server" CommandName="DeleteRow"
                                        CommandArgument='<%# Eval("Category_ID") %>' CssClass="btn btn-sm btn-danger"
