<%@ Page Title="Manage Questions" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="TestQuestions.aspx.cs" Inherits="interview_questions.Admin.TestQuestions" %>
    ...
    <asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="upload-section">
                ...
                <div class="form-row">
                    <div class="form-group full-width">
                        ...
                        <asp:FileUpload ID="fuTestQuestions" runat="server" />
                    </div>
                </div>
        ...
        <div class="table-card">
            ...
            <div class="table-wrapper">
                <asp:GridView ID="gvTestQuestions" runat="server" AutoGenerateColumns="False"
                    CssClass="table table-mobile-cards" DataKeyNames="Question_ID"
                    OnRowCommand="gvTestQuestions_RowCommand" GridLines="None" ShowHeaderWhenEmpty="True"
                    AllowPaging="True" PageSize="10" OnPageIndexChanging="gvTestQuestions_PageIndexChanging">
